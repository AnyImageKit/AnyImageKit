...
extension AnyImageViewController {
    ...
    func showAlert(message: String, stringConfig: StringConfigProtocol) {
...
extension AnyImageViewController {
    ...
    func check(permission: Permission, stringConfig: StringConfigProtocol, authorized: @escaping () -> Void, canceled: @escaping (Permission) -> Void) {
    ...
    func check(permissions: [Permission], stringConfig: StringConfigProtocol, authorized: @escaping () -> Void, canceled: @escaping (Permission) -> Void) {
        if !permissions.isEmpty {
            var _permissions = permissions
            let permission = _permissions.removeFirst()
