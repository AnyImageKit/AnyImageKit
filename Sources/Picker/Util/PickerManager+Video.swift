...
typealias _VideoFetchCompletion = (Result<VideoFetchResponse, ImagePickerError>) -> Void
typealias _VideoURLFetchCompletion = (Result<VideoURLFetchResponse, ImagePickerError>) -> Void
